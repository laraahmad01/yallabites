...
<div class="elfsight-app-d4584089-0638-4e88-918d-8800c058423d"></div>
...
<div class="form-group">
  ...
  <input type="text" class="form-control" id="rating" name="rating" placeholder="" list="ratingR">
        <datalist  id="ratingR">
            <option value="1">
            <option value="2">
            <option value="3">
...
<div class="form-group">
  ...
  <label for="description"></label>
        <input type="text" class="form-control"  id="description" name="description" placeholder="Review Description">
